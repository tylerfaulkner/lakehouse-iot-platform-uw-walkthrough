...
# MAGIC
# MAGIC
# MAGIC In the last notebook, our best model was automatically saved in our MLFlow registry.
# MAGIC
...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1655539421928636&notebook=%2F04-Data-Science-ML%2F04.3-running-inference-iot-turbine&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F04-Data-Science-ML%2F04.3-running-inference-iot-turbine&version=1">

# COMMAND ----------

# MAGIC %pip install mlflow==3.1.1 databricks-sdk==0.59.0 typing_extensions>=4.6.0
# MAGIC dbutils.library.restartPython()

# COMMAND ----------

import typing_extensions
print(typing_extensions.__version__ if hasattr(typing_extensions, '__version__') else 'Version not available')
...
# MAGIC
# MAGIC <a dbdemos-dashboard-id="turbine-predictive" href="/sql/dashboardsv3/01f11cc6289b1682a87759a315443db9">Open the Predictive Maintenance AI/BI dashboard</a> | [Go back to the introduction]($../00-IOT-wind-turbine-introduction-DI-platform)