...
# MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1655539421928636&notebook=%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-iot-turbine&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F01-Data-ingestion%2Fplain-spark-delta-pipeline%2F01.5-Delta-pipeline-spark-iot-turbine&version=1">
...
# MAGIC %sql LIST '/Volumes/workspace/dbdemos_iot_platform/turbine_raw_landing/incoming_data'

# COMMAND ----------

# DBTITLE 1,Review the raw sensor data received as JSON
# MAGIC %sql
# MAGIC SELECT * FROM PARQUET.`/Volumes/workspace/dbdemos_iot_platform/turbine_raw_landing/incoming_data`
