...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1655539421928636&notebook=%2F01-Data-ingestion%2F01.1-SDP-SQL%2F01.1-SDP-Wind-Turbine-SQL&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F01-Data-ingestion%2F01.1-SDP-SQL%2F01.1-SDP-Wind-Turbine-SQL&version=1">
...
-- MAGIC %md
-- MAGIC Your Spark Declarative Pipeline has been installed and started for you! Open the <a dbdemos-pipeline-id="sdp-sql" href="#joblist/pipelines/9c6f6446-7dfa-43a7-a6ff-dc68c5757169" target="_blank">IOT Wind Turbine Spark Declarative Pipeline</a> to see it in action.<br/>
-- MAGIC
...
-- MAGIC
-- MAGIC In this example, we'll implement an end 2 end Spark Declarative Pipeline consuming our Wind Turbine sensor data. <br/>
...
-- MAGIC
-- MAGIC ## Conclusion
-- MAGIC Our <a dbdemos-pipeline-id="sdp-sql" href="#joblist/pipelines/9c6f6446-7dfa-43a7-a6ff-dc68c5757169" target="_blank">Spark Declarative Pipeline</a> is now ready using purely SQL. We have an end 2 end cycle, and our ML model has been integrated seamlessly by our Data Engineering team.
-- MAGIC
-- MAGIC
...
-- MAGIC
-- MAGIC We are now ready to build our <a dbdemos-dashboard-id="turbine-analysis" href="/sql/dashboardsv3/01f11cc6285c181896fcf0d0886acd0d">AI/BI Dashboard</a> to track the main KPIs and status of our entire Wind Turbine Farm and build complete <a dbdemos-dashboard-id="turbine-predictive" href="/sql/dashboardsv3/01f11cc6285c181896fcf0d0886acd0d">Predictive maintenance AI/BI Dashboard</a>.
-- MAGIC
-- MAGIC
