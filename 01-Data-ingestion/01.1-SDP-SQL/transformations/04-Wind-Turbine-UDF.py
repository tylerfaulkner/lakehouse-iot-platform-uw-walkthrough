...
# Make sure you add this file in your Spark Declarative Pipelines job to have access to the `get_turbine_status` SQL function.
...
predict_maintenance_udf = mlflow.pyfunc.spark_udf(spark, "models:/workspace.dbdemos_iot_platform.dbdemos_turbine_maintenance@prod", "string", env_manager='virtualenv')
