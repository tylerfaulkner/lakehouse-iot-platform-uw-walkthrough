...
-- MAGIC
-- MAGIC > **First time here?** Run the [00-INSTALL-demo-resources]($./00-INSTALL-demo-resources) notebook first. It creates the data, pipeline, dashboards and job this walkthrough uses.
-- MAGIC
...
-- MAGIC %md
-- MAGIC
-- MAGIC Open the <a dbdemos-dashboard-id="turbine-predictive" href="/sql/dashboardsv3/01f11cc6285c181896fcf0d0886acd0d">Prescriptive maintenance AI/BI dashboard</a> to have a complete view of your wind turbine farm, including potential faulty turbines, work orders and actions to remedy that.
