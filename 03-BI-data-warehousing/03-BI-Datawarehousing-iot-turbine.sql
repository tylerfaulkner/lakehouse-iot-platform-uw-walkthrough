...
-- MAGIC <img width="1px" src="https://ppxrzfxige.execute-api.us-west-2.amazonaws.com/v1/analytics?category=lakehouse&org_id=1655539421928636&notebook=%2F03-BI-data-warehousing%2F03-BI-Datawarehousing-iot-turbine&demo_name=lakehouse-iot-platform&event=VIEW&path=%2F_dbdemos%2Flakehouse%2Flakehouse-iot-platform%2F03-BI-data-warehousing%2F03-BI-Datawarehousing-iot-turbine&version=1">
...
-- MAGIC
-- MAGIC Avoid expensive queries and materialize your tables. The engine will recompute only what's required when your data get updated. The best way to do so is using Spark Declarative Pipelines as shown here: <a dbdemos-pipeline-id="sdp-sql" href="#joblist/pipelines/9c6f6446-7dfa-43a7-a6ff-dc68c5757169" target="_blank">Spark Declarative Pipelines pipeline</a> or the [SQL notebook]($../01-Data-ingestion/01.1-SDP-SQL/01.1-SDP-Wind-Turbine-SQL)
