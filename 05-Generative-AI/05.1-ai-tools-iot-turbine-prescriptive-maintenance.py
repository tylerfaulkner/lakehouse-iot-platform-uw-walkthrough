...
# MAGIC FROM READ_FILES("/Volumes/workspace/dbdemos_iot_platform/turbine_raw_landing/maintenance_guide", format => 'binaryFile');
# MAGIC
...
# MAGIC %md
# MAGIC ## Exploring Mosaic AI Tools in Unity Catalog
# MAGIC
